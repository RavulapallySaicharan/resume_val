...
CANDIDATE_TABLE = "candidate_table_test_entire_summary"
VECTOR_TABLE = "vector_table_test_entire_summary"
JD_TABLE = "jd_candidate_table_test_entire_summary"


API_KEY = "sk-proj-STWsZQzGM9CGTkOI0lRsT3BlbkFJQv9gdY1t9XFSjhIAw5Ew"
# MODEL = "gpt-3.5-turbo"
MODEL = "gpt-4o"
...
def create_resume_extraction_prompt(text):
    ...
    Return the output in correct json format. Do not include comma after summary. Do not include any new key into the json. Use only below given keys.
        ...
        'country': Extract country of the candidate from the entire resume,
        'place' : Extract the location of the candidate from the entire resume,
...
def generate_response(prompt_template):
    ...
    client = OpenAI(api_key="sk-proj-STWsZQzGM9CGTkOI0lRsT3BlbkFJQv9gdY1t9XFSjhIAw5Ew")
